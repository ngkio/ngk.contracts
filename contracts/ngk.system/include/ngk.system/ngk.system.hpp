...
#include <ngk/producer_schedule.hpp>
#include <ngk/singleton.hpp>
#include <ngk/system.hpp>
#include <ngk/time.hpp>

#include <ngk.system/exchange_state.hpp>
...
namespace ngksystem {
   ...
   using ngk::asset;
   using ngk::block_timestamp;
   using ngk::check;
   using ngk::const_mem_fun;
   using ngk::datastream;
   using ngk::indexed_by;
   using ngk::name;
   using ngk::same_payer;
   using ngk::symbol;
   using ngk::symbol_code;
   using ngk::time_point;
   using ngk::time_point_sec;
   using ngk::unsigned_int;
   ...
   static constexpr uint64_t newaccount_cpu_stake  = 200;
   static constexpr uint64_t newaccount_net_stake  = 100;
   static constexpr uint64_t newaccount_ram 	   = 102400;

   /**
    * ngk.system contract
    * 
    * ngk.system contract defines the structures and actions needed for blockchain's core functionality.
   ...
   struct [[ngk::table, ngk::contract("ngk.system")]] name_bid {
     name            newname;
     name            high_bidder;
   ...
   struct [[ngk::table, ngk::contract("ngk.system")]] bid_refund {
      name         bidder;
      asset        amount;

      uint64_t primary_key()const { return bidder.value; }
   };
   typedef ngk::multi_index< "namebids"_n, name_bid,
                               indexed_by<"highbid"_n, const_mem_fun<name_bid, uint64_t, &name_bid::by_high_bid>  >
                             > name_bid_table;

   typedef ngk::multi_index< "bidrefunds"_n, bid_refund > bid_refund_table;

   // Defines new global state parameters.
   struct [[ngk::table("global"), ngk::contract("ngk.system")]] ngk_global_state : ngk::blockchain_parameters {
      ...
      NGKLIB_SERIALIZE_DERIVED( ngk_global_state, ngk::blockchain_parameters,
   ...
   struct [[ngk::table("global2"), ngk::contract("ngk.system")]] ngk_global_state2 {
      ngk_global_state2(){}
      ...
      NGKLIB_SERIALIZE( ngk_global_state2, (new_ram_per_block)(last_ram_increase)(last_block_num)
                        (total_producer_votepay_share)(revision) )
   };

   // Defines new global state parameters added after version 1.3.0
   struct [[ngk::table("global3"), ngk::contract("ngk.system")]] ngk_global_state3 {
      ngk_global_state3() { }
      time_point        last_vpay_state_update;
      double            total_vpay_share_change_rate = 0;

      NGKLIB_SERIALIZE( ngk_global_state3, (last_vpay_state_update)(total_vpay_share_change_rate) )
   };

   // Defines new global state parameters to store inflation rate and distribution
   struct [[ngk::table("global4"), ngk::contract("ngk.system")]] ngk_global_state4 {
      ngk_global_state4() { }
      double   continuous_rate;
      int64_t  inflation_pay_factor;
      int64_t  votepay_factor;

      NGKLIB_SERIALIZE( ngk_global_state4, (continuous_rate)(inflation_pay_factor)(votepay_factor) )
   };

   inline ngk::block_signing_authority convert_to_block_signing_authority( const ngk::public_key& producer_key ) {
      return ngk::block_signing_authority_v0{ .threshold = 1, .keys = {{producer_key, 1}} };
   }
   ...
   struct [[ngk::table, ngk::contract("ngk.system")]] producer_info {
      ...
      uint16_t                                                 location = 0;
      ngk::binary_extension<ngk::block_signing_authority>  producer_authority; // added in version 1.9.0
      ...
      ngk::block_signing_authority get_producer_authority()const {
         if( producer_authority.has_value() ) {
            bool zero_threshold = std::visit( [](auto&& auth ) -> bool {
               return (auth.threshold == 0);
            }, *producer_authority );
            // zero_threshold could be true despite the validation done in regproducer2 because the v1.9.0 ngk.system
            // contract has a bug which may have modified the producer table such that the producer_authority field
            // contains a default constructed ngk::block_signing_authority (which has a 0 threshold and so is invalid).
   ...
   struct [[ngk::table, ngk::contract("ngk.system")]] producer_info2 {
      name            owner;
      ...
      // explicit serialization macro is not necessary, used here only to improve compilation time
      NGKLIB_SERIALIZE( producer_info2, (owner)(votepay_share)(last_votepay_share_update) )
   };
   ...
   struct [[ngk::table, ngk::contract("ngk.system")]] voter_info {
      ...
      // explicit serialization macro is not necessary, used here only to improve compilation time
      NGKLIB_SERIALIZE( voter_info, (owner)(proxy)(producers)(staked)(last_vote_weight)(proxied_vote_weight)(is_proxy)(flags1)(reserved2)(reserved3) )
   };


   typedef ngk::multi_index< "voters"_n, voter_info >  voters_table;
   ...
   typedef ngk::multi_index< "producers2"_n, producer_info2 > producers_table2;


   typedef ngk::singleton< "global"_n, ngk_global_state >   global_state_singleton;

   typedef ngk::singleton< "global2"_n, ngk_global_state2 > global_state2_singleton;

   typedef ngk::singleton< "global3"_n, ngk_global_state3 > global_state3_singleton;

   typedef ngk::singleton< "global4"_n, ngk_global_state4 > global_state4_singleton;

   struct [[ngk::table, ngk::contract("ngk.system")]] user_resources {
      name          owner;
      asset         net_weight;
      asset         cpu_weight;
      int64_t       ram_bytes = 0;
      ...
      // explicit serialization macro is not necessary, used here only to improve compilation time
      NGKLIB_SERIALIZE( user_resources, (owner)(net_weight)(cpu_weight)(ram_bytes) )
   };

   // Every user 'from' has a scope/table that uses every receipient 'to' as the primary key.
   struct [[ngk::table, ngk::contract("ngk.system")]] delegated_bandwidth {
      name          from;
      name          to;
      asset         net_weight;
      asset         cpu_weight;
   ...
   struct [[ngk::table, ngk::contract("ngk.system")]] refund_request {
      name            owner;
      time_point_sec  request_time;
      ngk::asset    net_amount;
      ngk::asset    cpu_amount;
   ...
   typedef ngk::multi_index< "userres"_n, user_resources >      user_resources_table;
   typedef ngk::multi_index< "delband"_n, delegated_bandwidth > del_bandwidth_table;
   typedef ngk::multi_index< "refunds"_n, refund_request >      refunds_table;
   ...
   struct [[ngk::table,ngk::contract("ngk.system")]] rex_pool {
      uint8_t    version = 0;
      asset      total_lent;
      asset      total_unlent;
      asset      total_rent;
   ...
   typedef ngk::multi_index< "rexpool"_n, rex_pool > rex_pool_table;
   ...
   struct [[ngk::table,ngk::contract("ngk.system")]] rex_return_pool {
      uint8_t        version = 0;
   ...
   typedef ngk::multi_index< "rexretpool"_n, rex_return_pool > rex_return_pool_table;
   ...
   struct [[ngk::table,ngk::contract("ngk.system")]] rex_return_buckets {
      uint8_t                           version = 0;
   ...
   typedef ngk::multi_index< "retbuckets"_n, rex_return_buckets > rex_return_buckets_table;
   ...
   struct [[ngk::table,ngk::contract("ngk.system")]] rex_fund {
      uint8_t version = 0;
      name    owner;
      asset   balance;
   ...
   typedef ngk::multi_index< "rexfund"_n, rex_fund > rex_fund_table;
   ...
   struct [[ngk::table,ngk::contract("ngk.system")]] rex_balance {
      uint8_t version = 0;
      name    owner;
      asset   vote_stake;
      asset   rex_balance;
   ...
   typedef ngk::multi_index< "rexbal"_n, rex_balance > rex_balance_table;
   ...
   struct [[ngk::table,ngk::contract("ngk.system")]] rex_loan {
      uint8_t             version = 0;
      name                from;
      name                receiver;
      asset               payment;
   ...
   typedef ngk::multi_index< "cpuloan"_n, rex_loan,
   ...
   typedef ngk::multi_index< "netloan"_n, rex_loan,
                               indexed_by<"byexpr"_n,  const_mem_fun<rex_loan, uint64_t, &rex_loan::by_expr>>,
                               indexed_by<"byowner"_n, const_mem_fun<rex_loan, uint64_t, &rex_loan::by_owner>>
                             > rex_net_loan_table;

   struct [[ngk::table,ngk::contract("ngk.system")]] rex_order {
      uint8_t             version = 0;
      name                owner;
      asset               rex_requested;
      asset               proceeds;
      asset               stake_change;
      ngk::time_point   order_time;
      bool                is_open = true;
   ...
   typedef ngk::multi_index< "rexqueue"_n, rex_order,
   ...
   /**
    * The NGK system contract. The NGK system contract governs ram market, voters, producers, global state.
    */
   class [[ngk::contract("ngk.system")]] system_contract : public native {
      ...
      private:
         ...
         ngk_global_state       _gstate;
         ngk_global_state2      _gstate2;
         ngk_global_state3      _gstate3;
         ngk_global_state4      _gstate4;
      ...
      public:
         ...
         static constexpr ngk::name token_account{"ngk.token"_n};
         static constexpr ngk::name ram_account{"ngk.ram"_n};
         static constexpr ngk::name ramfee_account{"ngk.ramfee"_n};
         static constexpr ngk::name stake_account{"ngk.stake"_n};
         static constexpr ngk::name bpay_account{"ngk.bpay"_n};
         static constexpr ngk::name vpay_account{"ngk.vpay"_n};
         static constexpr ngk::name names_account{"ngk.names"_n};
         static constexpr ngk::name saving_account{"ngk.saving"_n};
         static constexpr ngk::name rex_account{"ngk.rex"_n};
         static constexpr ngk::name null_account{"ngk.null"_n};
         static constexpr ngk::name new_account{"ngk.new"_n};
       static constexpr symbol ramcore_symbol = symbol(symbol_code("RAMCORE"), 4);
         ...
         static symbol get_core_symbol( name system_account = "ngk"_n ) {
          ...
          */
         [[ngk::action]]
         void activate( const ngk::checksum256& feature_digest );
          ...
          */
         [[ngk::action]]
         void regproducer2( const name& producer, const ngk::block_signing_authority& producer_authority, const std::string& url, uint16_t location );
          ...
          * @pre Voter must have previously staked some NGK for voting
          ...
          */
         [[ngk::action]]
         void setparams( const ngk::blockchain_parameters& params );
          ...
          *     The remaining inflation will be sent to the `ngk.saving` account.
         ...
         using init_action = ngk::action_wrapper<"init"_n, &system_contract::init>;
         using setacctram_action = ngk::action_wrapper<"setacctram"_n, &system_contract::setacctram>;
         using setacctnet_action = ngk::action_wrapper<"setacctnet"_n, &system_contract::setacctnet>;
         using setacctcpu_action = ngk::action_wrapper<"setacctcpu"_n, &system_contract::setacctcpu>;
         using activate_action = ngk::action_wrapper<"activate"_n, &system_contract::activate>;
         using delegatebw_action = ngk::action_wrapper<"delegatebw"_n, &system_contract::delegatebw>;
         using deposit_action = ngk::action_wrapper<"deposit"_n, &system_contract::deposit>;
         using withdraw_action = ngk::action_wrapper<"withdraw"_n, &system_contract::withdraw>;
         using buyrex_action = ngk::action_wrapper<"buyrex"_n, &system_contract::buyrex>;
         using unstaketorex_action = ngk::action_wrapper<"unstaketorex"_n, &system_contract::unstaketorex>;
         using sellrex_action = ngk::action_wrapper<"sellrex"_n, &system_contract::sellrex>;
         using cnclrexorder_action = ngk::action_wrapper<"cnclrexorder"_n, &system_contract::cnclrexorder>;
         using rentcpu_action = ngk::action_wrapper<"rentcpu"_n, &system_contract::rentcpu>;
         using rentnet_action = ngk::action_wrapper<"rentnet"_n, &system_contract::rentnet>;
         using fundcpuloan_action = ngk::action_wrapper<"fundcpuloan"_n, &system_contract::fundcpuloan>;
         using fundnetloan_action = ngk::action_wrapper<"fundnetloan"_n, &system_contract::fundnetloan>;
         using defcpuloan_action = ngk::action_wrapper<"defcpuloan"_n, &system_contract::defcpuloan>;
         using defnetloan_action = ngk::action_wrapper<"defnetloan"_n, &system_contract::defnetloan>;
         using updaterex_action = ngk::action_wrapper<"updaterex"_n, &system_contract::updaterex>;
         using rexexec_action = ngk::action_wrapper<"rexexec"_n, &system_contract::rexexec>;
         using setrex_action = ngk::action_wrapper<"setrex"_n, &system_contract::setrex>;
         using mvtosavings_action = ngk::action_wrapper<"mvtosavings"_n, &system_contract::mvtosavings>;
         using mvfrsavings_action = ngk::action_wrapper<"mvfrsavings"_n, &system_contract::mvfrsavings>;
         using consolidate_action = ngk::action_wrapper<"consolidate"_n, &system_contract::consolidate>;
         using closerex_action = ngk::action_wrapper<"closerex"_n, &system_contract::closerex>;
         using undelegatebw_action = ngk::action_wrapper<"undelegatebw"_n, &system_contract::undelegatebw>;
         using buyram_action = ngk::action_wrapper<"buyram"_n, &system_contract::buyram>;
         using buyrambytes_action = ngk::action_wrapper<"buyrambytes"_n, &system_contract::buyrambytes>;
         using sellram_action = ngk::action_wrapper<"sellram"_n, &system_contract::sellram>;
         using refund_action = ngk::action_wrapper<"refund"_n, &system_contract::refund>;
         using regproducer_action = ngk::action_wrapper<"regproducer"_n, &system_contract::regproducer>;
         using regproducer2_action = ngk::action_wrapper<"regproducer2"_n, &system_contract::regproducer2>;
         using unregprod_action = ngk::action_wrapper<"unregprod"_n, &system_contract::unregprod>;
         using setram_action = ngk::action_wrapper<"setram"_n, &system_contract::setram>;
         using setramrate_action = ngk::action_wrapper<"setramrate"_n, &system_contract::setramrate>;
         using voteproducer_action = ngk::action_wrapper<"voteproducer"_n, &system_contract::voteproducer>;
         using regproxy_action = ngk::action_wrapper<"regproxy"_n, &system_contract::regproxy>;
         using claimrewards_action = ngk::action_wrapper<"claimrewards"_n, &system_contract::claimrewards>;
         using rmvproducer_action = ngk::action_wrapper<"rmvproducer"_n, &system_contract::rmvproducer>;
         using updtrevision_action = ngk::action_wrapper<"updtrevision"_n, &system_contract::updtrevision>;
         using bidname_action = ngk::action_wrapper<"bidname"_n, &system_contract::bidname>;
         using bidrefund_action = ngk::action_wrapper<"bidrefund"_n, &system_contract::bidrefund>;
         using setpriv_action = ngk::action_wrapper<"setpriv"_n, &system_contract::setpriv>;
         using setalimits_action = ngk::action_wrapper<"setalimits"_n, &system_contract::setalimits>;
         using setparams_action = ngk::action_wrapper<"setparams"_n, &system_contract::setparams>;
         using setinflation_action = ngk::action_wrapper<"setinflation"_n, &system_contract::setinflation>;
      ...
      private:
         ...
         //defined in ngk.system.cpp
         static ngk_global_state get_default_parameters();
         static ngk_global_state4 get_default_inflation_parameters();
         ...
         void register_producer( const name& producer, const ngk::block_signing_authority& producer_authority, const std::string& url, uint16_t location );
