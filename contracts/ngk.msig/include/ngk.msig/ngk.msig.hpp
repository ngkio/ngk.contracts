...
namespace ngk {
   ...
   /**
    * @defgroup ngkmsig ngk.msig
    * @ingroup ngkcontracts
    * ngk.msig contract defines the structures and actions needed to manage the proposals and approvals on blockchain.
    * @{
    */
   class [[ngk::contract("ngk.msig")]] multisig : public contract {
      public:
         ...
         void approve( name proposer, name proposal_name, permission_level level,
                       const ngk::binary_extension<ngk::checksum256>& proposal_hash );
         /**
         ...
         using propose_action = ngk::action_wrapper<"propose"_n, &multisig::propose>;
         using approve_action = ngk::action_wrapper<"approve"_n, &multisig::approve>;
         using unapprove_action = ngk::action_wrapper<"unapprove"_n, &multisig::unapprove>;
         using cancel_action = ngk::action_wrapper<"cancel"_n, &multisig::cancel>;
         using exec_action = ngk::action_wrapper<"exec"_n, &multisig::exec>;
         using invalidate_action = ngk::action_wrapper<"invalidate"_n, &multisig::invalidate>;
      ...
      private:
         ...
         typedef ngk::multi_index< "proposal"_n, proposal > proposals;

         struct [[ngk::table]] old_approvals_info {
            name                            proposal_name;
         ...
         typedef ngk::multi_index< "approvals"_n, old_approvals_info > old_approvals;
         ...
         typedef ngk::multi_index< "approvals2"_n, approvals_info > approvals;

         struct [[ngk::table]] invalidation {
            name         account;
         ...
         typedef ngk::multi_index< "invals"_n, invalidation > invalidations;
   };
   /** @}*/ // end of @defgroup ngkmsig ngk.msig
} /// namespace ngk
